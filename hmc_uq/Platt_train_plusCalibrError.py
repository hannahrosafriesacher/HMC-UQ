    ...
    for proportion_sampled in subsampling_list:
        for opt_metric in metrics:
            if from_ensemble == False:
                ...
                dirname_val="/home/rosa/git/AIDDProject/SingleTask/subsampling/predictions/"+sampling_type+"_subsampling/"+str(TargetID)+"/hp_optim_"+str(opt_metric)+"/propSampled_"+str(proportion_sampled)+"/platt/valFold_logits/"
                list_file_val=sorted(os.listdir(dirname_val))
                dirname_te="/home/rosa/git/AIDDProject/SingleTask/subsampling/predictions/"+sampling_type+"_subsampling/"+str(TargetID)+"/hp_optim_"+str(opt_metric)+"/propSampled_"+str(proportion_sampled)+"/platt/teFold_logits/"
            ...
            BRIER_list=[]
            for i in range(10):
                y_hat_vafold=np.load(dirname_val+ list_file_val[i])
                y_hat_tefold=np.load(dirname_te+ list_file_te[i])
                ...
                np.save("/home/rosa/git/AIDDProject/SingleTask/subsampling/predictions/"+sampling_type+"_subsampling/"+str(TargetID)+"/hp_optim_"+str(opt_metric)+"/propSampled_"+str(proportion_sampled)+"/platt/teFold_preds/" + list_file_val[i], y_platt_te)

            np.save("/home/rosa/git/AIDDProject/SingleTask/subsampling/data_csv_files/"+sampling_type+"/"+str(TargetID)+"/hp_optim_"+str(opt_metric)+"/platt/ECE/"+str(proportion_sampled)+"-ECE_"+list_file_te[i], ECE_list)
            np.save("/home/rosa/git/AIDDProject/SingleTask/subsampling/data_csv_files/"+sampling_type+"/"+str(TargetID)+"/hp_optim_"+str(opt_metric)+"/platt/ACE/"+str(proportion_sampled)+"-ACE_"+list_file_te[i], ACE_list)
            np.save("/home/rosa/git/AIDDProject/SingleTask/subsampling/data_csv_files/"+sampling_type+"/"+str(TargetID)+"/hp_optim_"+str(opt_metric)+"/platt/KDE/optimized/"+str(proportion_sampled)+"-KDE_"+list_file_te[i], KDE_list)
            np.save("/home/rosa/git/AIDDProject/SingleTask/subsampling/data_csv_files/"+sampling_type+"/"+str(TargetID)+"/hp_optim_"+str(opt_metric)+"/platt/ROC_AUC/"+str(proportion_sampled)+"-AUCROC_"+list_file_te[i], AUCROC_list)
            np.save("/home/rosa/git/AIDDProject/SingleTask/subsampling/data_csv_files/"+sampling_type+"/"+str(TargetID)+"/hp_optim_"+str(opt_metric)+"/platt/PR_AUC/"+str(proportion_sampled)+"-AUCPR_"+list_file_te[i], AUCPR_list)
            np.save("/home/rosa/git/AIDDProject/SingleTask/subsampling/data_csv_files/"+sampling_type+"/"+str(TargetID)+"/hp_optim_"+str(opt_metric)+"/platt/BRIER/"+str(proportion_sampled)+"-BRIER_"+list_file_te[i], BRIER_list)
